...
class ShortCycleTest {
     ...
     * - 생리 지연일: 없음
     * - 배란기: 없음 (조회 기간 내 배란기 없음, 다음 가임기는 2025-03-18부터)
     * - 가임기: 없음 (조회 기간 내 가임기 없음, 다음 가임기는 2025-03-18부터)
     * - 주기: 25일
     */
    @Test
     ...
     * TC-02-02: 1주일 조회
     *
     * 테스트 목적: 1주일 기간 조회 시 25일 주기의 상태 변화가 정확히 표시되는지 검증
     *
     ...
     * TC-02-03: 1개월 조회
     *
     * 테스트 목적: 1개월 전체 조회 시 실제 생리, 배란기, 가임기가 모두 정확히 표시되는지 검증 (25일 짧은 주기)
     *
     ...
     * - 생리 지연일: 없음
     * - 배란기: 2025-02-03 ~ 2025-02-05 (생리 시작 9-11일차)
     * - 가임기: 2025-01-31 ~ 2025-02-08 (생리 시작 6-14일차, 조회 범위와 부분 겹침)
     * - 주기: 25일
     *
     * 주기 2 (pk=3):
     ...
     * - 생리 예정일들: 없음
     * - 생리 지연일: 없음
     * - 배란기: 없음 (조회 범위 밖, 03-01 ~ 03-03)
     * - 가임기: 2025-02-25 ~ 2025-03-05 (생리 시작 6-14일차, 조회 범위와 부분 겹침)
     * - 주기: 25일
     */
    @Test
    fun testTC_02_03_oneMonthQuery() = runTest {
        ...
        // pk=3 주기 (Period 3): 실제 생리와 가임기 부분 포함
        ...
        assertEquals(0, cycle3.ovulationDays.size, "배란기 없음 (조회 범위 밖, 03-01 ~ 03-03)")
     ...
     */
    @Test
    fun testTC_02_04_periodBoundaryQuery() = runTest {
        val repository = createRepository()
     ...
     * TC-02-05: 생리 사이 조회
     *
     * 테스트 목적: 두 생리 사이 기간을 조회하여 배란기와 가임기가 짧은 주기 공식으로 정확히 계산되는지 검증
     *
     * 조회 기간: 2025-01-31 ~ 2025-02-19 (Period 2 종료 후 ~ Period 3 시작 전)
     *
     * 주기 1 (pk=2):
     * - 실제 생리 기록: 2025-01-26 ~ 2025-01-30 (두 번째 생리)
     ...
     * - 생리 지연일: 없음
     * - 배란기: 2025-02-03 ~ 2025-02-05 (생리 시작 9-11일차)
     * - 가임기: 2025-01-31 ~ 2025-02-08 (생리 시작 6-14일차)
     * - 주기: 25일
     *
     * 주기 2 (pk=3):
     ...
     */
    @Test
    fun testTC_02_05_betweenPeriodsQuery() = runTest {
        val repository = createRepository()

        val searchFrom = LocalDate(2025, 1, 31)
     ...
     * - 배란기들:
     *   - 2025-03-01 ~ 2025-03-03 (생리 시작 9-11일차)
     *   - 2025-03-26 ~ 2025-03-28
     *   - 2025-04-20 ~ 2025-04-22
     *   - 2025-05-15 ~ 2025-05-17
     * - 가임기들:
     *   - 2025-02-25 ~ 2025-03-05 (생리 시작 6-14일차, 조회 범위와 부분 겹침)
     *   - 2025-03-22 ~ 2025-03-30
     *   - 2025-04-16 ~ 2025-04-24
     *   - 2025-05-11 ~ 2025-05-19
     * - 주기: 25일
     */
    @Test
    fun testTC_02_06_threeMonthQuery() = runTest {
        val repository = createRepository()
     ...
     */
    @Test
    fun testTC_02_07_predictedPeriodQuery() = runTest {
        val repository = createRepository()
     ...
     * - 가임기들: 2025-02-25 ~ 2025-03-05 (조회 범위 03-01 ~ 03-03와 부분 겹침)
     * - 주기: 25일
     */
    @Test
    fun testTC_02_08_ovulationPeriodQuery() = runTest {
        val repository = createRepository()
     ...
     * - 가임기들: 2025-02-25 ~ 2025-03-05 (조회 범위 02-25 ~ 02-28와 부분 겹침)
     * - 주기: 25일
     */
    @Test
    fun testTC_02_09_fertilePeriodQuery() = runTest {
        val repository = createRepository()
