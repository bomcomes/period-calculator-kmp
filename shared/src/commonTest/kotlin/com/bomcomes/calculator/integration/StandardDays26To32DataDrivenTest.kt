 ...
 */
class StandardDays26To32DataDrivenTest {
                    ...
                    ExpectedCycle(
                        ...
                        fertileDays = listOf(
                            DateRange(
                                ...
                                endDate = DateUtils.toJulianDay(LocalDate(2025, 2, 19))
                            )
                        ),
                        ovulationDays = listOf(
                            DateRange(
                ...
                expectedCycles = listOf(
                    ExpectedCycle(
                        ...
                        predictDays = listOf(
                            ...
                            DateRange(
                                startDate = DateUtils.toJulianDay(LocalDate(2025, 5, 30)),
                                endDate = DateUtils.toJulianDay(LocalDate(2025, 6, 3))
                            )
                        ),
                        fertileDays = listOf(
                            DateRange(
                            ...
                            DateRange(
                                startDate = DateUtils.toJulianDay(LocalDate(2025, 5, 7)),
                        ...
                        ovulationDays = listOf(
                            ...
                            DateRange(
                                startDate = DateUtils.toJulianDay(LocalDate(2025, 5, 12)),
                                endDate = DateUtils.toJulianDay(LocalDate(2025, 5, 14))
                            )
                        ),
                        period = 30
                    )
