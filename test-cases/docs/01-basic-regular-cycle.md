...
## TC-01-02: 1주일 조회
### 📌 테스트 목적
1주일 기간 조회 시 해당 주의 상태 변화가 정확히 표시되는지 검증
...
- [ ] 1주일 내의 배란기가 표시되는가
- [ ] 1주일 내의 가임기가 표시되는가
- [ ] 기간이 조회 범위를 넘어가는 경우 올바르게 필터링되는가

---

## TC-01-03: 1개월 조회
### 📌 테스트 목적
1개월 전체 조회 시 실제 생리, 배란기, 가임기가 모두 정확히 표시되는지 검증
...
- [ ] Period 2의 배란기/가임기가 정확히 계산되는가
- [ ] Period 3의 배란기/가임기는 조회 범위 밖이므로 비어있는가
...
## TC-01-05: 생리 사이 조회
### 📌 테스트 목적
두 생리 사이 기간을 조회하여 배란기와 가임기가 정확히 계산되는지 검증
...
### 🔍 검증 포인트
- [ ] 실제 생리 기록 사이 구간의 배란기가 정확히 계산되는가 (pk=2)
- [ ] 실제 생리 기록 사이 구간의 가임기가 정확히 계산되는가 (pk=2)
