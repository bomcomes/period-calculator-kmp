# 표준일 피임법 검증
- 생리 주기의 처음 7일 동안은 안전기이며, 8일부터 19일까지는 가임기고, 20일부터 다시 안전기 (계산 실패 확률 5%)
...
- 지연 일수: 0일
- 지연 기간: null
- 생리 예정일들: 없음 (조회 기간 내 생리 예정일 없음, 다음 예정일은 2025-03-31)
- 가임기들:
  - 2025-03-08 ~ 2025-03-19 (조회일 3/15가 가임기 범위 내)
- 배란기들:
  - 2025-03-13 ~ 2025-03-15 (조회일 3/15가 가임기 범위 내)
- 주기: 30일
- 배란일 사용자 입력: false
...
- [ ] delayTheDays는 8로 계산되고 delayDay도 8일간 표시되는가
